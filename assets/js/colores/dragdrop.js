  ...
  if (document.readyState === 'complete') {
    ...
    function drop(event) {
      ...
      if(isCorrectMatching) {
        ...
        event.target.insertAdjacentHTML("afterbegin", `<img src="../../assets/images/modules/colores/dragdrop/${draggableElementData}80x80.png" alt="">`);
        const audio = {
            negro: negro,
            rojo: rojo,
            blanco: blanco,
